describe("Image Fallthrough", () => {
  it("should display image from fragment", () => {
    ...
    cy.get("#hero .header-image").should(
      "have.css",
      "background-image",
      'url("http://localhost:1313/dev/resource-fallthrough/fragment/hero/resource_logo.png")'
    );
  });
  ...
  it("should display image from page", () => {
    ...
    cy.get("#hero .header-image").should(
      "have.css",
      "background-image",
      'url("http://localhost:1313/dev/resource-fallthrough/page/resource_logo.png")'
    );
  });
  ...
  it("should display image from global", () => {
    ...
    cy.get("#hero .header-image").should(
      "have.css",
      "background-image",
      'url("http://localhost:1313/images/resource_logo.png")'
    );
  });
});
